 ...
 * 
 * @param {object} params
 * @param {string} params.status - human readable status
 * @param {function} callback
 */
Client.prototype.setPresence = function (params, callback) {
    var body = {
        presence: {
...
Client.prototype.sendGroupMessage = function (params, callback) {
    if (!params.groupId) {
